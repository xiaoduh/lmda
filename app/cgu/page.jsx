  ...
  return (
    <main>
      ...
      <div className="legal">
        ...
        <p>
          L&apos;édition du site www.lambda-labs.fr est assurée par la Société
          SAS Lambda-Labs au capital de 3000 euros, immatriculée au RCS de
          Bobigny sous le numéro 980 507 008, dont le siège social est situé au
          2 Esplanade Ferdinand-Magellan 93160 Noisy-le-Grand Numéro de
          téléphone +33668670457 Adresse e-mail : hello@lambda-labs.fr. Le
          Directeur de la publication est : Mohamed-Amine ABIDI L&apos;hébergeur
          du site www.lambda-labs.fr est la société Lambda-Labs, dont le siège
          social est situé au 2 Esplanade Ferdinand-Magellan 93160
          Noisy-le-Grand, avec le numéro de téléphone : +33668670457.
        </p>
        <h3>ARTICLE 2 : Accès au site</h3>
        <p>
          Le site www.lambda-labs.fr permet à l&apos;Utilisateur un accès
          gratuit aux services suivants : Le site internet propose les services
          suivants : Plateforme de mise en relation, Plateforme de
          référencement, Annuaire de référencement, Plateforme d&apos;emplois Le
          site est accessible gratuitement en tout lieu à tout Utilisateur ayant
          un accès à Internet. Tous les frais supportés par l&apos;Utilisateur
          pour accéder au service (matériel informatique, logiciels, connexion
          Internet, etc.) sont à sa charge. L’Utilisateur non membre n&apos;a
          pas accès aux services réservés. Pour cela, il doit s’inscrire en
          remplissant le formulaire. En acceptant de s’inscrire aux services
          ...
          notamment son adresse email. Pour accéder aux services, l’Utilisateur
          doit ensuite s&apos;identifier à l&apos;aide de son identifiant et de
        ...
        <p>
          ...
          Informatique et Libertés, en date du 6 janvier 1978,
          ...
          l&apos;adresse email hello@lambda-labs.fr﻿
        </p>
        ...
        <p>
          ...
          droit d&apos;auteur. L&apos;Utilisateur doit solliciter
          l&apos;autorisation préalable du site pour toute reproduction,
          publication, copie des différents contenus. Il s&apos;engage à une
          utilisation des contenus du site dans un cadre strictement privé,
        ...
        <p>
          Les sources des informations diffusées sur le site www.lambda-labs.fr
          ...
          www.lambda-labs.fr ne peut être tenu responsable de la modification
          ...
          site. L&apos;Utilisateur s&apos;assure de garder son mot de passe
          ...
          identifiant et mot de passe. Le site décline toute responsabilité. Le
          site www.lambda-labs.fr ne peut être tenu pour responsable d’éventuels
        ...
        <p>
          ...
          www.lambda-labs.fr. Ce dernier n’a pas de contrôle sur les pages web
        ...
        <p>
          ...
          www.lambda-labs.fr. Les cookies ne contiennent pas d’information
          ...
          cookies est utilisée pour améliorer le site www.lambda-labs.fr. En
          naviguant sur le site, L’Utilisateur les accepte. L’Utilisateur pourra
        ...
        <p>
          ...
          connaître. Pour toute question relative à l’application des présentes
          CGU, vous pouvez joindre l’éditeur aux coordonnées inscrites à
          l’ARTICLE 1.
        </p>
      </div>
      <FooterApp />
