...
export default function Home() {
  return (
    <main style={{ height: "3000px" }}>
      ...
      urna cursus vestibulum. Fusce commodcu. Nam commodo suscipit quam. Quisque
      id odio. Praesent venenatis metus at tortor pulvinar varius.Lorem ipsum
      ...
      montes, nascetur ridiculus Ruler [î] TopShare: Facebook Twitter Google
      Diigo DeliciousHome | Imprint | v1.8(noflash) |{" "}
    </main>
  );
}
